...
class AppFixtures extends Fixture
{
    ...
    private function loadPosts(ObjectManager $manager): void
    {
        foreach ($this->getPostData() as [$title, $slug, $summary, $content, $publishedAt, $author, $tags]) {
            ...
            foreach (range(1, 5) as $i) {
                ...
                $commentAuthor = $this->getReference('ascender_user');
    ...
    {
        return [
            ['Ascender Admin', 'ascender_admin', 'blackpug', 'garry+ascender_admin@blackpugltd.com', ['ROLE_ADMIN']],
            ['Ascender User', 'ascender_user', 'blackpug', 'garry+ascender_user@blackpugltd.com', ['ROLE_USER']],
        ];
    }
    ...
    private function getPostData(): array
    {
        ...
        foreach ($this->getPhrases() as $i => $title) {
            ...
            /** @var User $user */
            $user = $this->getReference('ascender_admin');
